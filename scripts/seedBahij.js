...
async function seed() {
  console.log('Connecting to MongoDB (Bahij ERP)...');
  ...
  // 1.1 Seed Admin User
  const hashedHamza = await bcrypt.hash('bahij_king_2026', 10);
  await User.create({
    name: 'Dr. Hamza',
  ...
  const menuItems = [
    // الشوربة
    {
      ...
      price: 135,
      category: 'الشوربة',
      description: 'أقوى شوربة فسفور في الشرق الأوسط',
      recipe: [
    ...
    // السندوتشات
    {
      name: 'صاروخ بهيج (الصاروخ النووي)',
      price: 85,
      category: 'السندوتشات',
